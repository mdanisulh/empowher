                ...
                : Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        border: Border(bottom: BorderSide(width: 1.5, color: Colors.grey.shade500)),
                        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.2), blurRadius: 5, spreadRadius: 5, offset: const Offset(5, 5))],
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const Icon(Icons.share, color: Pallete.black, size: 25),
                              ],
                            ),
                          ),
                        ],
